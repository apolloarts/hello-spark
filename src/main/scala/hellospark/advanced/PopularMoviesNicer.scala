...
object PopularMoviesNicer {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("src/main/resources/data/ml-100k/u.item")
  ...
  def main(args: Array[String]) {
    ...
    val lines = sc.textFile("src/main/resources/data/ml-100k/u.data")
